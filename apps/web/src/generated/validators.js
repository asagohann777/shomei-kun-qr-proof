...
const schema34 = {"type":"object","additionalProperties":false,"required":["mode"],"properties":{"mode":{"type":"string","enum":["mock","live"]}},"description":"今回はmockのみ返す。liveは将来の実接続用。mockの場合、実ウォレットへの引渡しと外部取引リンクを禁止する。"};
...
const schema36 = {"type":"object","additionalProperties":false,"required":["chainId","contractAddress","issuer"],"properties":{"chainId":{"type":"integer","const":80002},"contractAddress":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"issuer":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"}}};
...
if(80002 !== data0){
validate25.errors = [{instancePath:instancePath+"/chainId",schemaPath:"#/properties/chainId/const",keyword:"const",params:{allowedValue: 80002},message:"must be equal to constant"}];
return false;
}
var valid0 = _errs2 === errors;
}
...
const schema40 = {"type":"object","additionalProperties":false,"required":["cardId","registry","playerName","status","owner","evidence"],"properties":{"cardId":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[A-Za-z0-9_-]+$"},"registry":{"type":"object","additionalProperties":false,"required":["chainId","contractAddress","issuer"],"properties":{"chainId":{"type":"integer","const":80002},"contractAddress":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"issuer":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"}}},"playerName":{"type":"string"},"status":{"type":"string","enum":["unregistered"]},"owner":{"type":"null"},"evidence":{"type":"object","additionalProperties":false,"required":["status"],"properties":{"status":{"type":"string","enum":["none"]}}}}};
...
if(80002 !== data2){
validate29.errors = [{instancePath:instancePath+"/registry/chainId",schemaPath:"#/properties/registry/properties/chainId/const",keyword:"const",params:{allowedValue: 80002},message:"must be equal to constant"}];
return false;
}
...
const schema41 = {"type":"object","additionalProperties":false,"required":["cardId","registry","playerName","status","owner","evidence"],"properties":{"cardId":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[A-Za-z0-9_-]+$"},"registry":{"type":"object","additionalProperties":false,"required":["chainId","contractAddress","issuer"],"properties":{"chainId":{"type":"integer","const":80002},"contractAddress":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"issuer":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"}}},"playerName":{"type":"string"},"status":{"type":"string","enum":["registered"]},"owner":{"type":"object","additionalProperties":false,"required":["address","nickname"],"properties":{"address":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"nickname":{"type":"string","minLength":1}}},"evidence":{"oneOf":[{"type":"object","additionalProperties":false,"required":["status","transactionHash","blockNumber"],"properties":{"status":{"type":"string","enum":["available"]},"transactionHash":{"type":"string","pattern":"^0x[0-9a-fA-F]{64}$"},"blockNumber":{"type":"integer","minimum":0}}},{"type":"object","additionalProperties":false,"required":["status"],"properties":{"status":{"type":"string","enum":["pending"]}}}]}}};
...
if(80002 !== data2){
validate30.errors = [{instancePath:instancePath+"/registry/chainId",schemaPath:"#/properties/registry/properties/chainId/const",keyword:"const",params:{allowedValue: 80002},message:"must be equal to constant"}];
return false;
}
var valid1 = _errs7 === errors;
}
...
const schema42 = {"type":"object","additionalProperties":false,"required":["walletAddress","chainId","nickname"],"properties":{"walletAddress":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"chainId":{"type":"integer","minimum":1},"nickname":{"type":"string","minLength":1}}};
...
const schema43 = {"type":"object","additionalProperties":false,"required":["chainId","from","to","data","value"],"properties":{"chainId":{"type":"integer","const":80002},"from":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"to":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"data":{"type":"string","pattern":"^0x(?:[0-9a-fA-F]{2})*$"},"value":{"type":"string","const":"0"}},"description":"共通転送形式。valueはweiの10進文字列。この操作は送金しない。モックのdata=0xはABI未確定のプレースホルダーで、実送信不可。nonce・gas・手数料は含めない。"};
...
if(80002 !== data0){
validate32.errors = [{instancePath:instancePath+"/chainId",schemaPath:"#/properties/chainId/const",keyword:"const",params:{allowedValue: 80002},message:"must be equal to constant"}];
return false;
}
var valid0 = _errs2 === errors;
}
...
const schema44 = {"type":"object","additionalProperties":false,"required":["cardId","nickname","transaction"],"properties":{"cardId":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[A-Za-z0-9_-]+$"},"nickname":{"type":"string","minLength":1},"transaction":{"type":"object","additionalProperties":false,"required":["chainId","from","to","data","value"],"properties":{"chainId":{"type":"integer","const":80002},"from":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"to":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"data":{"type":"string","pattern":"^0x(?:[0-9a-fA-F]{2})*$"},"value":{"type":"string","const":"0"}},"description":"共通転送形式。valueはweiの10進文字列。この操作は送金しない。モックのdata=0xはABI未確定のプレースホルダーで、実送信不可。nonce・gas・手数料は含めない。"}}};
...
if(80002 !== data3){
validate33.errors = [{instancePath:instancePath+"/transaction/chainId",schemaPath:"#/properties/transaction/properties/chainId/const",keyword:"const",params:{allowedValue: 80002},message:"must be equal to constant"}];
return false;
}
var valid1 = _errs9 === errors;
}
...
if(80002 !== data5){
const err9 = {instancePath:instancePath+"/data/registry/chainId",schemaPath:"#/properties/data/oneOf/0/properties/registry/properties/chainId/const",keyword:"const",params:{allowedValue: 80002},message:"must be equal to constant"};
if(vErrors === null){
vErrors = [err9];
}
else {
...
const err10 = {instancePath:instancePath+"/data/registry/contractAddress",schemaPath:"#/properties/data/oneOf/0/properties/registry/properties/contractAddress/pattern",keyword:"pattern",params:{pattern: "^0x[0-9a-fA-F]{40}$"},message:"must match pattern \""+"^0x[0-9a-fA-F]{40}$"+"\""};
if(vErrors === null){
vErrors = [err10];
}
else {
...
const err11 = {instancePath:instancePath+"/data/registry/contractAddress",schemaPath:"#/properties/data/oneOf/0/properties/registry/properties/contractAddress/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err11];
}
else {
...
const err12 = {instancePath:instancePath+"/data/registry/issuer",schemaPath:"#/properties/data/oneOf/0/properties/registry/properties/issuer/pattern",keyword:"pattern",params:{pattern: "^0x[0-9a-fA-F]{40}$"},message:"must match pattern \""+"^0x[0-9a-fA-F]{40}$"+"\""};
if(vErrors === null){
vErrors = [err12];
}
else {
...
const err13 = {instancePath:instancePath+"/data/registry/issuer",schemaPath:"#/properties/data/oneOf/0/properties/registry/properties/issuer/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err13];
}
else {
...
const err14 = {instancePath:instancePath+"/data/registry",schemaPath:"#/properties/data/oneOf/0/properties/registry/type",keyword:"type",params:{type: "object"},message:"must be object"};
if(vErrors === null){
vErrors = [err14];
}
else {
...
const err15 = {instancePath:instancePath+"/data/playerName",schemaPath:"#/properties/data/oneOf/0/properties/playerName/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err15];
}
else {
...
const _errs25 = errors;
if(typeof data9 !== "string"){
const err16 = {instancePath:instancePath+"/data/status",schemaPath:"#/properties/data/oneOf/0/properties/status/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err16];
}
else {
...
const err17 = {instancePath:instancePath+"/data/status",schemaPath:"#/properties/data/oneOf/0/properties/status/enum",keyword:"enum",params:{allowedValues: schema49.properties.data.oneOf[0].properties.status.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err17];
}
else {
...
if(data2.owner !== null){
const err18 = {instancePath:instancePath+"/data/owner",schemaPath:"#/properties/data/oneOf/0/properties/owner/type",keyword:"type",params:{type: "null"},message:"must be null"};
if(vErrors === null){
vErrors = [err18];
}
else {
...
const err19 = {instancePath:instancePath+"/data/evidence",schemaPath:"#/properties/data/oneOf/0/properties/evidence/required",keyword:"required",params:{missingProperty: missing4},message:"must have required property '"+missing4+"'"};
if(vErrors === null){
vErrors = [err19];
}
else {
...
if(!(key4 === "status")){
const err20 = {instancePath:instancePath+"/data/evidence",schemaPath:"#/properties/data/oneOf/0/properties/evidence/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key4},message:"must NOT have additional properties"};
if(vErrors === null){
vErrors = [err20];
}
else {
...
if(typeof data12 !== "string"){
const err21 = {instancePath:instancePath+"/data/evidence/status",schemaPath:"#/properties/data/oneOf/0/properties/evidence/properties/status/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err21];
}
else {
...
if(!(data12 === "none")){
const err22 = {instancePath:instancePath+"/data/evidence/status",schemaPath:"#/properties/data/oneOf/0/properties/evidence/properties/status/enum",keyword:"enum",params:{allowedValues: schema49.properties.data.oneOf[0].properties.evidence.properties.status.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err22];
}
else {
...
const err23 = {instancePath:instancePath+"/data/evidence",schemaPath:"#/properties/data/oneOf/0/properties/evidence/type",keyword:"type",params:{type: "object"},message:"must be object"};
if(vErrors === null){
vErrors = [err23];
}
else {
...
const err24 = {instancePath:instancePath+"/data",schemaPath:"#/properties/data/oneOf/0/type",keyword:"type",params:{type: "object"},message:"must be object"};
if(vErrors === null){
vErrors = [err24];
}
else {
...
const err25 = {instancePath:instancePath+"/data",schemaPath:"#/properties/data/oneOf/1/required",keyword:"required",params:{missingProperty: missing5},message:"must have required property '"+missing5+"'"};
if(vErrors === null){
vErrors = [err25];
}
else {
...
const err26 = {instancePath:instancePath+"/data",schemaPath:"#/properties/data/oneOf/1/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key5},message:"must NOT have additional properties"};
if(vErrors === null){
vErrors = [err26];
}
else {
...
if(func1(data13) > 64){
const err27 = {instancePath:instancePath+"/data/cardId",schemaPath:"#/properties/data/oneOf/1/properties/cardId/maxLength",keyword:"maxLength",params:{limit: 64},message:"must NOT have more than 64 characters"};
if(vErrors === null){
vErrors = [err27];
}
else {
...
if(func1(data13) < 1){
const err28 = {instancePath:instancePath+"/data/cardId",schemaPath:"#/properties/data/oneOf/1/properties/cardId/minLength",keyword:"minLength",params:{limit: 1},message:"must NOT have fewer than 1 characters"};
if(vErrors === null){
vErrors = [err28];
}
else {
...
const err29 = {instancePath:instancePath+"/data/cardId",schemaPath:"#/properties/data/oneOf/1/properties/cardId/pattern",keyword:"pattern",params:{pattern: "^[A-Za-z0-9_-]+$"},message:"must match pattern \""+"^[A-Za-z0-9_-]+$"+"\""};
if(vErrors === null){
vErrors = [err29];
}
else {
...
const err30 = {instancePath:instancePath+"/data/cardId",schemaPath:"#/properties/data/oneOf/1/properties/cardId/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err30];
}
else {
...
const err31 = {instancePath:instancePath+"/data/registry",schemaPath:"#/properties/data/oneOf/1/properties/registry/required",keyword:"required",params:{missingProperty: missing6},message:"must have required property '"+missing6+"'"};
if(vErrors === null){
vErrors = [err31];
}
else {
...
const err32 = {instancePath:instancePath+"/data/registry",schemaPath:"#/properties/data/oneOf/1/properties/registry/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key6},message:"must NOT have additional properties"};
if(vErrors === null){
vErrors = [err32];
}
else {
...
const err33 = {instancePath:instancePath+"/data/registry/chainId",schemaPath:"#/properties/data/oneOf/1/properties/registry/properties/chainId/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err33];
}
else {
...
if(80002 !== data15){
const err34 = {instancePath:instancePath+"/data/registry/chainId",schemaPath:"#/properties/data/oneOf/1/properties/registry/properties/chainId/const",keyword:"const",params:{allowedValue: 80002},message:"must be equal to constant"};
if(vErrors === null){
vErrors = [err34];
}
else {
...
const err35 = {instancePath:instancePath+"/data/registry/contractAddress",schemaPath:"#/properties/data/oneOf/1/properties/registry/properties/contractAddress/pattern",keyword:"pattern",params:{pattern: "^0x[0-9a-fA-F]{40}$"},message:"must match pattern \""+"^0x[0-9a-fA-F]{40}$"+"\""};
if(vErrors === null){
vErrors = [err35];
}
else {
...
const err36 = {instancePath:instancePath+"/data/registry/contractAddress",schemaPath:"#/properties/data/oneOf/1/properties/registry/properties/contractAddress/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err36];
}
else {
...
const err37 = {instancePath:instancePath+"/data/registry/issuer",schemaPath:"#/properties/data/oneOf/1/properties/registry/properties/issuer/pattern",keyword:"pattern",params:{pattern: "^0x[0-9a-fA-F]{40}$"},message:"must match pattern \""+"^0x[0-9a-fA-F]{40}$"+"\""};
if(vErrors === null){
vErrors = [err37];
}
else {
...
const err38 = {instancePath:instancePath+"/data/registry/issuer",schemaPath:"#/properties/data/oneOf/1/properties/registry/properties/issuer/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err38];
}
else {
...
const err39 = {instancePath:instancePath+"/data/registry",schemaPath:"#/properties/data/oneOf/1/properties/registry/type",keyword:"type",params:{type: "object"},message:"must be object"};
if(vErrors === null){
vErrors = [err39];
}
else {
...
if(typeof data2.playerName !== "string"){
const err40 = {instancePath:instancePath+"/data/playerName",schemaPath:"#/properties/data/oneOf/1/properties/playerName/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err40];
}
else {
...
const err41 = {instancePath:instancePath+"/data/status",schemaPath:"#/properties/data/oneOf/1/properties/status/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err41];
}
else {
...
const err42 = {instancePath:instancePath+"/data/status",schemaPath:"#/properties/data/oneOf/1/properties/status/enum",keyword:"enum",params:{allowedValues: schema49.properties.data.oneOf[1].properties.status.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err42];
}
else {
...
const err43 = {instancePath:instancePath+"/data/owner",schemaPath:"#/properties/data/oneOf/1/properties/owner/required",keyword:"required",params:{missingProperty: missing7},message:"must have required property '"+missing7+"'"};
if(vErrors === null){
vErrors = [err43];
}
else {
...
const err44 = {instancePath:instancePath+"/data/owner",schemaPath:"#/properties/data/oneOf/1/properties/owner/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key7},message:"must NOT have additional properties"};
if(vErrors === null){
vErrors = [err44];
}
else {
...
const err45 = {instancePath:instancePath+"/data/owner/address",schemaPath:"#/properties/data/oneOf/1/properties/owner/properties/address/pattern",keyword:"pattern",params:{pattern: "^0x[0-9a-fA-F]{40}$"},message:"must match pattern \""+"^0x[0-9a-fA-F]{40}$"+"\""};
if(vErrors === null){
vErrors = [err45];
}
else {
...
const err46 = {instancePath:instancePath+"/data/owner/address",schemaPath:"#/properties/data/oneOf/1/properties/owner/properties/address/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err46];
}
else {
...
if(func1(data22) < 1){
const err47 = {instancePath:instancePath+"/data/owner/nickname",schemaPath:"#/properties/data/oneOf/1/properties/owner/properties/nickname/minLength",keyword:"minLength",params:{limit: 1},message:"must NOT have fewer than 1 characters"};
if(vErrors === null){
vErrors = [err47];
}
else {
...
const err48 = {instancePath:instancePath+"/data/owner/nickname",schemaPath:"#/properties/data/oneOf/1/properties/owner/properties/nickname/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err48];
}
else {
...
const err49 = {instancePath:instancePath+"/data/owner",schemaPath:"#/properties/data/oneOf/1/properties/owner/type",keyword:"type",params:{type: "object"},message:"must be object"};
if(vErrors === null){
vErrors = [err49];
}
else {
...
const err50 = {instancePath:instancePath+"/data/evidence",schemaPath:"#/properties/data/oneOf/1/properties/evidence/oneOf/0/required",keyword:"required",params:{missingProperty: missing8},message:"must have required property '"+missing8+"'"};
if(vErrors === null){
vErrors = [err50];
}
else {
...
const err51 = {instancePath:instancePath+"/data/evidence",schemaPath:"#/properties/data/oneOf/1/properties/evidence/oneOf/0/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key8},message:"must NOT have additional properties"};
if(vErrors === null){
vErrors = [err51];
}
else {
...
const err52 = {instancePath:instancePath+"/data/evidence/status",schemaPath:"#/properties/data/oneOf/1/properties/evidence/oneOf/0/properties/status/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err52];
}
else {
...
const err54 = {instancePath:instancePath+"/data/evidence/transactionHash",schemaPath:"#/properties/data/oneOf/1/properties/evidence/oneOf/0/properties/transactionHash/pattern",keyword:"pattern",params:{pattern: "^0x[0-9a-fA-F]{64}$"},message:"must match pattern \""+"^0x[0-9a-fA-F]{64}$"+"\""};
if(vErrors === null){
vErrors = [err54];
}
else {
...
const err55 = {instancePath:instancePath+"/data/evidence/transactionHash",schemaPath:"#/properties/data/oneOf/1/properties/evidence/oneOf/0/properties/transactionHash/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err55];
}
else {
...
const err56 = {instancePath:instancePath+"/data/evidence/blockNumber",schemaPath:"#/properties/data/oneOf/1/properties/evidence/oneOf/0/properties/blockNumber/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err56];
}
else {
...
const err57 = {instancePath:instancePath+"/data/evidence/blockNumber",schemaPath:"#/properties/data/oneOf/1/properties/evidence/oneOf/0/properties/blockNumber/minimum",keyword:"minimum",params:{comparison: ">=", limit: 0},message:"must be >= 0"};
if(vErrors === null){
vErrors = [err57];
}
else {
...
const err58 = {instancePath:instancePath+"/data/evidence",schemaPath:"#/properties/data/oneOf/1/properties/evidence/oneOf/0/type",keyword:"type",params:{type: "object"},message:"must be object"};
if(vErrors === null){
vErrors = [err58];
}
else {
...
const err59 = {instancePath:instancePath+"/data/evidence",schemaPath:"#/properties/data/oneOf/1/properties/evidence/oneOf/1/required",keyword:"required",params:{missingProperty: missing9},message:"must have required property '"+missing9+"'"};
if(vErrors === null){
vErrors = [err59];
}
else {
...
if(!(key9 === "status")){
const err60 = {instancePath:instancePath+"/data/evidence",schemaPath:"#/properties/data/oneOf/1/properties/evidence/oneOf/1/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key9},message:"must NOT have additional properties"};
if(vErrors === null){
vErrors = [err60];
}
else {
...
const err61 = {instancePath:instancePath+"/data/evidence/status",schemaPath:"#/properties/data/oneOf/1/properties/evidence/oneOf/1/properties/status/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err61];
}
else {
...
const err63 = {instancePath:instancePath+"/data/evidence",schemaPath:"#/properties/data/oneOf/1/properties/evidence/oneOf/1/type",keyword:"type",params:{type: "object"},message:"must be object"};
if(vErrors === null){
vErrors = [err63];
}
else {
...
if(!valid9){
const err64 = {instancePath:instancePath+"/data/evidence",schemaPath:"#/properties/data/oneOf/1/properties/evidence/oneOf",keyword:"oneOf",params:{passingSchemas: passing1},message:"must match exactly one schema in oneOf"};
if(vErrors === null){
vErrors = [err64];
}
else {
...
const err65 = {instancePath:instancePath+"/data",schemaPath:"#/properties/data/oneOf/1/type",keyword:"type",params:{type: "object"},message:"must be object"};
if(vErrors === null){
vErrors = [err65];
}
else {
...
if(!valid2){
const err66 = {instancePath:instancePath+"/data",schemaPath:"#/properties/data/oneOf",keyword:"oneOf",params:{passingSchemas: passing0},message:"must match exactly one schema in oneOf"};
if(vErrors === null){
vErrors = [err66];
}
else {
...
const schema50 = {"type":"object","additionalProperties":false,"required":["meta","data"],"properties":{"meta":{"type":"object","additionalProperties":false,"required":["mode"],"properties":{"mode":{"type":"string","enum":["mock","live"]}},"description":"今回はmockのみ返す。liveは将来の実接続用。mockの場合、実ウォレットへの引渡しと外部取引リンクを禁止する。"},"data":{"type":"object","additionalProperties":false,"required":["cardId","nickname","transaction"],"properties":{"cardId":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[A-Za-z0-9_-]+$"},"nickname":{"type":"string","minLength":1},"transaction":{"type":"object","additionalProperties":false,"required":["chainId","from","to","data","value"],"properties":{"chainId":{"type":"integer","const":80002},"from":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"to":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"data":{"type":"string","pattern":"^0x(?:[0-9a-fA-F]{2})*$"},"value":{"type":"string","const":"0"}},"description":"共通転送形式。valueはweiの10進文字列。この操作は送金しない。モックのdata=0xはABI未確定のプレースホルダーで、実送信不可。nonce・gas・手数料は含めない。"}}}}};
...
if(80002 !== data6){
validate39.errors = [{instancePath:instancePath+"/data/transaction/chainId",schemaPath:"#/properties/data/properties/transaction/properties/chainId/const",keyword:"const",params:{allowedValue: 80002},message:"must be equal to constant"}];
return false;
}
...
const schema51 = {"type":"object","additionalProperties":false,"required":["meta","data"],"properties":{"meta":{"type":"object","additionalProperties":false,"required":["mode"],"properties":{"mode":{"type":"string","enum":["mock","live"]}},"description":"今回はmockのみ返す。liveは将来の実接続用。mockの場合、実ウォレットへの引渡しと外部取引リンクを禁止する。"},"data":{"oneOf":[{"type":"object","additionalProperties":false,"required":["cardId","transactionHash","status"],"properties":{"cardId":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[A-Za-z0-9_-]+$"},"transactionHash":{"type":"string","pattern":"^0x[0-9a-fA-F]{64}$"},"status":{"type":"string","enum":["pending"]}}},{"type":"object","additionalProperties":false,"required":["cardId","transactionHash","status","owner","blockNumber"],"properties":{"cardId":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[A-Za-z0-9_-]+$"},"transactionHash":{"type":"string","pattern":"^0x[0-9a-fA-F]{64}$"},"status":{"type":"string","enum":["confirmed"]},"owner":{"type":"object","additionalProperties":false,"required":["address","nickname"],"properties":{"address":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"nickname":{"type":"string","minLength":1}}},"blockNumber":{"type":"integer","minimum":0}}},{"type":"object","additionalProperties":false,"required":["cardId","transactionHash","status"],"properties":{"cardId":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[A-Za-z0-9_-]+$"},"transactionHash":{"type":"string","pattern":"^0x[0-9a-fA-F]{64}$"},"status":{"type":"string","enum":["reverted"]}}},{"type":"object","additionalProperties":false,"required":["cardId","transactionHash","status","reason"],"properties":{"cardId":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[A-Za-z0-9_-]+$"},"transactionHash":{"type":"string","pattern":"^0x[0-9a-fA-F]{64}$"},"status":{"type":"string","enum":["unknown"]},"reason":{"type":"string","enum":["TRANSACTION_NOT_SEEN","RECORD_MISMATCH"]}}}]}}};
...
const schema52 = {"type":"object","additionalProperties":false,"required":["meta","error"],"properties":{"meta":{"type":"object","additionalProperties":false,"required":["mode"],"properties":{"mode":{"type":"string","enum":["mock","live"]}},"description":"今回はmockのみ返す。liveは将来の実接続用。mockの場合、実ウォレットへの引渡しと外部取引リンクを禁止する。"},"error":{"type":"object","additionalProperties":false,"required":["code","message"],"properties":{"code":{"type":"string","enum":["INVALID_INPUT","INVALID_MOCK_SCENARIO","CARD_NOT_FOUND","ALREADY_REGISTERED","WALLET_NOT_ALLOWED","CHAIN_MISMATCH","MOCK_SAMPLE_UNSUPPORTED","UPSTREAM_UNAVAILABLE","INTERNAL_ERROR","PAYLOAD_TOO_LARGE","UNSUPPORTED_MEDIA_TYPE"]},"message":{"type":"string","minLength":1}}}}};
...
validate41.errors = [{instancePath:instancePath+"/error",schemaPath:"#/properties/error/required",keyword:"required",params:{missingProperty: missing2},message:"must have required property '"+missing2+"'"}];
return false;
}
else {
const _errs9 = errors;
...
validate41.errors = [{instancePath:instancePath+"/error",schemaPath:"#/properties/error/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key2},message:"must NOT have additional properties"}];
return false;
break;
}
}
...
const _errs10 = errors;
if(typeof data3 !== "string"){
validate41.errors = [{instancePath:instancePath+"/error/code",schemaPath:"#/properties/error/properties/code/type",keyword:"type",params:{type: "string"},message:"must be string"}];
return false;
}
if(!(((((((((((data3 === "INVALID_INPUT") || (data3 === "INVALID_MOCK_SCENARIO")) || (data3 === "CARD_NOT_FOUND")) || (data3 === "ALREADY_REGISTERED")) || (data3 === "WALLET_NOT_ALLOWED")) || (data3 === "CHAIN_MISMATCH")) || (data3 === "MOCK_SAMPLE_UNSUPPORTED")) || (data3 === "UPSTREAM_UNAVAILABLE")) || (data3 === "INTERNAL_ERROR")) || (data3 === "PAYLOAD_TOO_LARGE")) || (data3 === "UNSUPPORTED_MEDIA_TYPE"))){
validate41.errors = [{instancePath:instancePath+"/error/code",schemaPath:"#/properties/error/properties/code/enum",keyword:"enum",params:{allowedValues: schema52.properties.error.properties.code.enum},message:"must be equal to one of the allowed values"}];
return false;
}
var valid2 = _errs10 === errors;
}
...
if(typeof data4 === "string"){
if(func1(data4) < 1){
validate41.errors = [{instancePath:instancePath+"/error/message",schemaPath:"#/properties/error/properties/message/minLength",keyword:"minLength",params:{limit: 1},message:"must NOT have fewer than 1 characters"}];
return false;
}
}
else {
validate41.errors = [{instancePath:instancePath+"/error/message",schemaPath:"#/properties/error/properties/message/type",keyword:"type",params:{type: "string"},message:"must be string"}];
return false;
}
}
var valid2 = _errs12 === errors;
...
validate41.errors = [{instancePath:instancePath+"/error",schemaPath:"#/properties/error/type",keyword:"type",params:{type: "object"},message:"must be object"}];
return false;
}
}
var valid0 = _errs7 === errors;
