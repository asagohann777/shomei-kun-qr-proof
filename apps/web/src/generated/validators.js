...
const schema31 = {"type":"object","additionalProperties":false,"required":["meta","data"],"properties":{"meta":{"type":"object","additionalProperties":false,"required":["mode"],"properties":{"mode":{"type":"string","enum":["mock","live"]}},"description":"Mock mode simulates operations; live mode reads actual records on the configured chain. Mock transactions must not be submitted."},"data":{"type":"object","additionalProperties":false,"required":["address","name","ensChainId"],"properties":{"address":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"name":{"type":["string","null"],"maxLength":255},"ensChainId":{"type":"integer","const":11155111}}}}};
...
const schema38 = {"type":"object","additionalProperties":false,"required":["mode"],"properties":{"mode":{"type":"string","enum":["mock","live"]}},"description":"Mock mode simulates operations; live mode reads actual records on the configured chain. Mock transactions must not be submitted."};
...
const schema46 = {"type":"object","additionalProperties":false,"required":["walletAddress","chainId","nickname"],"properties":{"walletAddress":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"chainId":{"type":"integer","minimum":1,"maximum":9007199254740991},"nickname":{"type":"string","minLength":1,"description":"Live mode accepts 1 to 96 UTF-8 bytes and rejects invalid Unicode without trimming or normalization. Mock mode accepts only the fixed sample."}}};
...
const schema47 = {"type":"object","additionalProperties":false,"required":["chainId","from","to","data","value"],"properties":{"chainId":{"type":"integer","minimum":1,"maximum":9007199254740991},"from":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"to":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"data":{"type":"string","pattern":"^0x(?:[0-9a-fA-F]{2})*$"},"value":{"type":"string","const":"0"}},"description":"Shared transport format. Value is a decimal string in wei; this operation transfers no funds. Mock data=0x is a placeholder for an undefined ABI and must not be submitted. Nonce, gas, and fee fields are omitted."};
...
const schema48 = {"type":"object","additionalProperties":false,"required":["cardId","nickname","transaction"],"properties":{"cardId":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[A-Za-z0-9_-]+$"},"nickname":{"type":"string","minLength":1},"transaction":{"type":"object","additionalProperties":false,"required":["chainId","from","to","data","value"],"properties":{"chainId":{"type":"integer","minimum":1,"maximum":9007199254740991},"from":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"to":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"data":{"type":"string","pattern":"^0x(?:[0-9a-fA-F]{2})*$"},"value":{"type":"string","const":"0"}},"description":"Shared transport format. Value is a decimal string in wei; this operation transfers no funds. Mock data=0x is a placeholder for an undefined ABI and must not be submitted. Nonce, gas, and fee fields are omitted."}}};
...
const schema54 = {"type":"object","additionalProperties":false,"required":["meta","data"],"properties":{"meta":{"type":"object","additionalProperties":false,"required":["mode"],"properties":{"mode":{"type":"string","enum":["mock","live"]}},"description":"Mock mode simulates operations; live mode reads actual records on the configured chain. Mock transactions must not be submitted."},"data":{"type":"object","additionalProperties":false,"required":["cardId","nickname","transaction"],"properties":{"cardId":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[A-Za-z0-9_-]+$"},"nickname":{"type":"string","minLength":1},"transaction":{"type":"object","additionalProperties":false,"required":["chainId","from","to","data","value"],"properties":{"chainId":{"type":"integer","minimum":1,"maximum":9007199254740991},"from":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"to":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"data":{"type":"string","pattern":"^0x(?:[0-9a-fA-F]{2})*$"},"value":{"type":"string","const":"0"}},"description":"Shared transport format. Value is a decimal string in wei; this operation transfers no funds. Mock data=0x is a placeholder for an undefined ABI and must not be submitted. Nonce, gas, and fee fields are omitted."}}}}};
...
const schema55 = {"type":"object","additionalProperties":false,"required":["meta","data"],"properties":{"meta":{"type":"object","additionalProperties":false,"required":["mode"],"properties":{"mode":{"type":"string","enum":["mock","live"]}},"description":"Mock mode simulates operations; live mode reads actual records on the configured chain. Mock transactions must not be submitted."},"data":{"oneOf":[{"type":"object","additionalProperties":false,"required":["cardId","transactionHash","status"],"properties":{"cardId":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[A-Za-z0-9_-]+$"},"transactionHash":{"type":"string","pattern":"^0x[0-9a-fA-F]{64}$"},"status":{"type":"string","enum":["pending"]}}},{"type":"object","additionalProperties":false,"required":["cardId","transactionHash","status","owner","blockNumber"],"properties":{"cardId":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[A-Za-z0-9_-]+$"},"transactionHash":{"type":"string","pattern":"^0x[0-9a-fA-F]{64}$"},"status":{"type":"string","enum":["confirmed"]},"owner":{"type":"object","additionalProperties":false,"required":["address","nickname"],"properties":{"address":{"type":"string","pattern":"^0x[0-9a-fA-F]{40}$"},"nickname":{"type":"string","minLength":1}}},"blockNumber":{"type":"integer","minimum":0}}},{"type":"object","additionalProperties":false,"required":["cardId","transactionHash","status"],"properties":{"cardId":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[A-Za-z0-9_-]+$"},"transactionHash":{"type":"string","pattern":"^0x[0-9a-fA-F]{64}$"},"status":{"type":"string","enum":["reverted"]}}},{"type":"object","additionalProperties":false,"required":["cardId","transactionHash","status","reason"],"properties":{"cardId":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[A-Za-z0-9_-]+$"},"transactionHash":{"type":"string","pattern":"^0x[0-9a-fA-F]{64}$"},"status":{"type":"string","enum":["unknown"]},"reason":{"type":"string","enum":["TRANSACTION_NOT_SEEN","RECORD_MISMATCH"]}}}]}}};
