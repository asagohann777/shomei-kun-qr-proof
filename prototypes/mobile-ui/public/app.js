...
function tradingCard() {
  return `<div class="trading-card"><img src="./player.svg" alt="${t('cardAlt')}" width="240" height="336"><img class="card-qr" src="${liveEnabled ? (qrSource ?? 'data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%221%22 height=%221%22/%3E') : './card-qr.svg'}" alt="${t('qrAlt')}"></div>`;
}
