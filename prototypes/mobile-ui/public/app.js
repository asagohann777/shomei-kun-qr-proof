...
function tradingCard() {
  return `<div class="trading-card"><div class="card-art"><img src="./assets/trading-card.jpg" alt="${t('cardAlt')}" width="1180" height="1333"></div><img class="card-qr" src="./card-qr.svg" alt="${t('qrAlt')}"></div>`;
}
